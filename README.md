...
Легковесный пакетный скрипт Windows для блокировки работы приложения-мессенджера MAX в локальной системе.
...
* **Язык скриптов:** Windows Batch (.bat)
...
* **Чистый код:** Написан стандартными средствами Windows Batch, не требует стороннего ПО.
